		                ...
		                @foreach ($cart as $key => $value)
			                    ...
			                    <td>
			                        <div class="product-item">
			                            <a class="product-thumb" href="#"><img src="{{ asset($value['image']) }}" alt="Product" style="height: 180px;"></a>
			                    ...
			                    <td class="text-center"><a class="remove-from-cart" href="{{ route('delete_cart' , $value['id']-1) }}" data-toggle="tooltip" title="" data-original-title="Remove item"><i class="fa fa-trash"></i></a></td>
			                </tr>
			            @endforeach
			        </tbody>
			    </table>
